try:
    import pygame     #by pip install at cmd 
    import sys
    import math
    from tkinter import *
...
class spot:
    def __init__(self, x, y):    #youtube tutorial A* Algorithm
        self.i = x
        self.j = y
        self.f = 0
        self.g = 0
...
row = 50
openSet = []
closedSet = []                       #https://www.starpathfinding.com
red = (255, 0, 0)
green = (0, 255, 0)
sblue = (0, 0, 255)
grey = (220, 220, 220)
...
for i in range(cols):                       #youtube tutorial A* Algorithm
    for j in range(row):
